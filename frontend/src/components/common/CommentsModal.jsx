...
import { X, MessageCircle, Search, Calendar, Filter, SortAsc, SortDesc, Trash2 } from 'lucide-react';

export const CommentsModal = ({ isOpen, onClose, contentType, contentId, contentTitle }) => {
