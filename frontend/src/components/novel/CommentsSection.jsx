...
const CommentsSection = ({ 
              ...
              <button
                ...
                className={`px-3 py-2 rounded-lg border transition-colors text-sm ${
                  currentPage === page
                    ...
                    : 'border-slate-600/50 bg-slate-700/50 text-white hover:bg-slate-600/50'
                }`}
              >
                {page}
              </button>
  ...
  return (
    <div className="bg-slate-800/30 border border-slate-600/50 rounded-lg p-4 sm:p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={sortDropdownRef}>
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 bg-slate-700/50 border border-slate-600/50 rounded-lg text-white hover:bg-slate-600/50 transition-colors text-sm"
            >
                        ...
                        <div key={reply.id} className="bg-slate-800/30 border border-slate-600/30 rounded-lg p-3">
                          <div className="flex items-start justify-between mb-2">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {/* Bouton de signalement pour les réponses */}
                              <ReportButton 
                                contentType="reply" 
                                contentId={reply.id}
                                size="sm"
