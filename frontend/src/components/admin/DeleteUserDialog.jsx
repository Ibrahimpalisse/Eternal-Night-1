            ...
            >
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white/[0.07] backdrop-blur-xl border border-white/20 p-8 text-left align-middle shadow-[0_8px_32px_rgb(0_0_0/0.4)] transition-all hover:shadow-red-500/10">
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full px-4 py-3 bg-white/[0.05] border border-white/20 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/50 transition-all duration-300"
                                            disabled={isLoading}
                                        />
                                        <button
                                            type="button"
                                ...
                                <div className="flex gap-4 justify-end">
                                    ...
                                    >
                                        ...
                                        {isLoading ? (
                                            <div className="w-4 h-4 mr-2 border-2 border-white/30 border-t-white rounded-full animate-spin relative z-10" />
                                        ) : (
                                            <Trash2 className="w-4 h-4 mr-2 relative z-10" />
                                        )}
