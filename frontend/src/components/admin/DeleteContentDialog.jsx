...
import { Trash2, AlertTriangle, Eye, EyeOff, Lock, BookOpen, FileText } from 'lucide-react';

const DeleteContentDialog = ({ isOpen, setIsOpen, item, type, onConfirm }) => {
    ...
    return {
      icon: BookOpen,
      label: 'roman',
      details: `${item?.chaptersCount || 0} chapitres`
    };
  };
                            ...
                            <Dialog.Panel className="w-full max-w-md mx-3 sm:mx-0 transform overflow-hidden rounded-2xl bg-white/[0.07] backdrop-blur-xl border border-white/20 p-4 sm:p-6 md:p-8 text-left align-middle shadow-[0_8px_32px_rgb(0_0_0/0.4)] transition-all hover:shadow-red-500/10">
                                <div className="flex items-center mb-6 sm:mb-8">
                                    ...
                                    <div>
                                        ...
                                        >
                                            Suppression de {contentInfo.label}
                                        </Dialog.Title>
                                        ...
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-400 text-sm">
                                                    {contentInfo.details} • {item?.author}
                                                </p>
                                            </div>
                                        </div>
                                        <p className="text-white/90 leading-relaxed mb-2 sm:mb-3 text-sm sm:text-base">
                                            Êtes-vous sûr de vouloir supprimer ce {contentInfo.label} ?
                                        </p>
                                        <p className="text-red-400 text-xs sm:text-sm">
                                            ⚠️ Cette action supprimera définitivement toutes les données associées.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="mb-4 sm:mb-6">
                                    <label className="block text-xs sm:text-sm font-medium text-white/80 mb-2 sm:mb-3">
                                        ...
                                        Confirmez avec votre mot de passe administrateur
                                    </label>
